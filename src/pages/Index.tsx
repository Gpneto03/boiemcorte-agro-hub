      ...
      <footer className="py-10 px-6 border-t border-border bg-gradient-to-t from-primary/5 to-background">
        <div className="max-w-2xl mx-auto text-center space-y-4">
          ...
          <div className="flex items-center justify-center gap-5">
            <a href={TIKTOK_URL} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="TikTok">
            ...
            <a href="https://www.facebook.com/boiemcorte" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Facebook">
            ...
            <a href="https://www.instagram.com/boi_em_corte" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Instagram">
