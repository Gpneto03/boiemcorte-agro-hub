...
import heroBg from "@/assets/hero-moringa-bg.jpg";
import { TrendingUp, Sun, DollarSign, Sprout, BookOpen, CheckCircle2, ArrowLeft } from "lucide-react";
...
const Moringa = () => {
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      {/* HEADER */}
      <header className="relative z-20 bg-foreground/95 backdrop-blur-sm border-b border-primary/30">
        <div className="max-w-6xl mx-auto flex flex-col items-center gap-2 py-4 md:py-5 px-4">
          <Link to="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
            ...
            <span className="text-xl md:text-2xl font-display font-bold tracking-[0.2em] text-primary-foreground">BOI EM CORTE</span>
          </Link>
      ...
      <section className="py-10 md:py-14 px-4 md:px-6 bg-gradient-to-b from-foreground to-foreground/95">
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
          {[
            ...
            <div
              key={item.number}
              className="border border-primary/30 rounded-2xl p-5 md:p-6 text-center space-y-2 hover:border-primary/60 transition-colors bg-foreground/50"
            >
              <span className="text-3xl md:text-4xl font-display font-bold text-primary">
                {item.number}
              </span>
              <p className="text-sm text-primary-foreground/70 font-light leading-snug">
                {item.label}
              </p>
            </div>
          ))}
      ...
      {/* PROBLEMA */}
      <section className="py-12 md:py-20 px-4 md:px-6 bg-gradient-to-b from-foreground/95 to-foreground/90">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center space-y-3">
            <h2 className="text-2xl md:text-4xl font-bold leading-tight text-primary-foreground">
          ...
          <div className="max-w-3xl mx-auto space-y-4 text-sm md:text-base text-primary-foreground/60 font-light leading-relaxed">
            <p>
            ...
            <p>
              ...
              <strong className="text-primary-foreground font-semibold">O problema não é o mercado. O problema é depender dele.</strong>
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 pt-4">
            {[
              ...
              <div
                key={item.title}
                className="group relative border border-primary/20 rounded-2xl p-5 md:p-6 space-y-3 bg-foreground/80 hover:border-primary/50 transition-all duration-300 overflow-hidden"
              >
                ...
                <h3 className="text-base md:text-lg font-display font-bold text-primary-foreground">{item.title}</h3>
                <p className="text-sm text-primary-foreground/60 font-light leading-relaxed">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* SOLUÇÃO */}
      <section className="py-12 md:py-20 px-4 md:px-6 bg-gradient-to-b from-foreground/90 to-foreground/95">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center space-y-3">
            <h2 className="text-2xl md:text-4xl font-bold leading-tight text-primary-foreground">
              Do plantio ao cocho.{" "}
          ...
          <p className="max-w-3xl mx-auto text-center text-sm md:text-base text-primary-foreground/60 font-light leading-relaxed">
            Este não é um guia teórico. É um <strong className="text-primary-foreground font-semibold">manual de campo</strong> — com números reais e regras práticas para quem quer resultado desde o primeiro corte, não uma leitura para admirar na estante.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5 pt-4">
            {[
              ...
              <div key={i} className="flex items-start gap-3 p-4 rounded-xl border border-primary/20 hover:border-primary/40 transition-colors bg-foreground/80">
                <CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                <span className="text-sm md:text-base font-light text-primary-foreground/80">{item}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* CTA FINAL */}
      <section className="py-16 md:py-24 px-4 md:px-6 bg-gradient-to-b from-foreground/95 to-foreground">
        <div className="max-w-4xl mx-auto">
          <div className="relative bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/30 rounded-2xl p-8 md:p-14 overflow-hidden">
            ...
            <div className="relative flex flex-col lg:flex-row items-center gap-8">
              <div className="flex-1 space-y-4 text-center lg:text-left">
                ...
                <p className="text-sm md:text-base text-primary-foreground/60 font-light">
      ...
      {/* FOOTER */}
      <footer className="py-8 px-6 border-t border-primary/20 bg-foreground">
        <div className="max-w-2xl mx-auto text-center space-y-3">
          <Link to="/" className="inline-flex items-center gap-2 text-sm text-primary-foreground/60 hover:text-primary transition-colors">
            <ArrowLeft className="w-4 h-4" />
            Voltar para a página principal
          </Link>
          <p className="text-sm text-primary-foreground/40 font-display tracking-widest">
            PECUÁRIA SEM RODEIO
          </p>
        </div>
      </footer>
