...
const CHECKOUT_URL = "#"; // TODO: replace with real checkout link
...
const Moringa = () => {
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      {/* HERO */}
      <section className="relative py-12 md:py-20 px-4 md:px-6 bg-gradient-to-b from-secondary/80 to-background overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center">
            ...
            {/* Right — Ebook Cover */}
            <div className="flex-shrink-0 w-64 md:w-80 animate-fade-up-delay-1">
              <img
                src={ebookCover}
      ...
      <section className="py-10 md:py-14 px-4 md:px-6 bg-background">
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
          {[
            ...
            { number: "4t", label: "Proteína produzida por hectare/ano" },
            { number: "120", label: "Animais suplementados com 1 hectare" },
          ].map((item) => (
            <div
              key={item.number}
              className="border border-border rounded-2xl p-5 md:p-6 text-center space-y-2 hover:border-primary/50 transition-colors"
            >
      ...
      {/* PROBLEMA */}
      <section className="py-12 md:py-20 px-4 md:px-6 bg-gradient-to-b from-background to-secondary/50">
      ...
      {/* SOLUÇÃO */}
      <section className="py-12 md:py-20 px-4 md:px-6 bg-gradient-to-b from-secondary/50 to-background">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center space-y-3">
            <h2 className="text-2xl md:text-4xl font-bold leading-tight">
              Do plantio ao cocho.{" "}
          ...
          <div className="relative bg-foreground text-background rounded-2xl p-8 md:p-14 overflow-hidden">
            ...
            <div className="relative flex flex-col lg:flex-row items-center gap-8">
              ...
              <img
                ...
                className="w-40 md:w-52 drop-shadow-2xl flex-shrink-0"
              />
            </div>
          </div>
        </div>
